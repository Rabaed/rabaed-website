 ...
 * and alert address in the CMS. A form joins by being added here — tickets
 * 28–30 add theirs — with a migration for its settings.
 */
export const SUBMITTABLE_FORMS: readonly FormDefinition[] = [DEMO_REQUEST];
