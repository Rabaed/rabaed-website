...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_posts_locale" AS ENUM('ar', 'en');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_locale" AS ENUM('ar', 'en');
  ...
  CREATE TABLE "posts" (
  	...
  	"summary" varchar,
  	"slug" varchar,
  	"locale" "enum_posts_locale" DEFAULT 'ar',
  	"author" varchar,
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_locale" "enum__posts_v_version_locale" DEFAULT 'ar',
  ...
  CREATE INDEX "_posts_v_version_version_locale_idx" ON "_posts_v" USING btree ("version_locale");
