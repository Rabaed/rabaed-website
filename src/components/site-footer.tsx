import { FOOTER_LEGAL_LINKS, WHATSAPP_URL } from '@/content/navigation';
 ...
 *
 * The four social icons point at `#` because no account links have been
 * supplied yet. That is the Reference site's state and the spec's: they are
 * listed as awaiting the founders, ticket 21 makes them editable, and ticket
 * 39 will not let the site go public with them still empty. WhatsApp is real.
 */
    ...
    <footer>
      <div className="wrap">
        ...
        <div className="social">
          <a href="#" aria-label="لينكدإن" target="_blank" rel="noopener">
          ...
          <a href="#" aria-label="إكس" target="_blank" rel="noopener">
          ...
          <a href="#" aria-label="فيسبوك" target="_blank" rel="noopener">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <a href="#" aria-label="إنستجرام" target="_blank" rel="noopener">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <a href={WHATSAPP_URL} aria-label="واتساب" target="_blank" rel="noopener">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
