...
- **A replaced picture has no crop.** Until ticket 79 lets an Editor upload one, phones show a replaced Screen mock whole, with ticket 77's hint, and never the exported crop of the screen it replaced.
