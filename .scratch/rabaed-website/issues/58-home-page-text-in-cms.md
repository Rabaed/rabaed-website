...
- **A new, empty migration carries the whole schema's snapshot** (`20260915_204815_product_and_tool_pages_snapshot`). Ticket 57's migration sorts before ticket 54's, so the newest snapshot was the tool page's, which has none of ticket 57's tables, and the home page's migration first came out creating them again.
